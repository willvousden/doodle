...
args=()
for time in 2018-10-{15..19}T09Z 2018-10-17T{10..11}Z; do
    args+=(-F "time=$time")
done
...
args=()
for time in 2018-10-{15,17}T{12..17}Z 2018-10-{16,18}T{09..11}Z; do
    args+=(-F "time=$time")
done
...
args=()
for time in 2018-10-{15..19}T{09..15}Z; do
    args+=(-F "time=$time")
done
